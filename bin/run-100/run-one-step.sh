#!/bin/bash
#SBATCH -e run-one-step.err
#SBATCH --mem-per-cpu=2G
#SBATCH -c 20

module load CPLEX
module load Gurobi/8.11
################################# lattice + one_step + L=100 + GGCN/linear/liear_raw + epsilon=0 ################################# 
...
# python3 ./src/run/run.py --env_name='sis' --policy_name='one_step' --argmaxer_name='sweep' \
#      --omega=0.0 --number_of_replicates=20 --rollout_depth=1 --time_horizon=25 --L=100 --gamma=0.9 \
...
############################### nearestneighbor + one_step + L=100 + GGCN/linear/liear_raw + epsilon=0 ################################# 
python3 ./src/run/run.py --env_name='sis' --policy_name='one_step' --argmaxer_name='quad_approx' \
     --omega=0.0 --number_of_replicates=20 --rollout_depth=1 --time_horizon=25 --L=100 --gamma=0.9 \
...
################################# contrived + one_step + L=100 + GGCN/linear/liear_raw + epsilon=0 ################################# 
python3 ./src/run/run.py --env_name='sis' --policy_name='one_step' --argmaxer_name='quad_approx' \
     --omega=0.0 --number_of_replicates=20 --rollout_depth=1 --time_horizon=25 --L=100 --gamma=0.9 \
