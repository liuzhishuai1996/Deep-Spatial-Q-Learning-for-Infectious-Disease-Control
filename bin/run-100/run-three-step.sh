...
python3 ./src/run/run.py --env_name='sis' --policy_name='three_step' --argmaxer_name='quad_approx' \
...
# python3 ./src/run/run.py --env_name='sis' --policy_name='three_step' --argmaxer_name='sweep' \
#      --omega=0.0 --number_of_replicates=20 --rollout_depth=1 --time_horizon=25 --L=100 --gamma=0.9 \
...
############################### nearestneighbor + three_step + L=100 + GGCN/linear/liear_raw + epsilon=0 ################################# 
python3 ./src/run/run.py --env_name='sis' --policy_name='three_step' --argmaxer_name='quad_approx' \
     --omega=0.0 --number_of_replicates=20 --rollout_depth=1 --time_horizon=25 --L=100 --gamma=0.9 \
...
################################# contrived + three_step + L=100 + GGCN/linear/liear_raw + epsilon=0 ################################# 
python3 ./src/run/run.py --env_name='sis' --policy_name='three_step' --argmaxer_name='quad_approx' \
     --omega=0.0 --number_of_replicates=20 --rollout_depth=1 --time_horizon=25 --L=100 --gamma=0.9 \
