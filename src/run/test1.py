...
from src.estimation.q_functions.embedding import learn_ggcn
...
class Simulator_test1(object):
  ...
  def episode(self, replicate):
    ...
    for t in range(self.time_horizon-5):
      ...
      predictor1, _ = tune_ggcn1(env.X_raw[3:-1], y, env.adjacency_list, n_epoch=200, num_settings_to_try=10)
      #testing
      mse_gnn = 0.
      mse_l = 0.
      base = 0.
      ...
      print(f'mse_gnn: {mse_gnn} mse_l: {mse_l} base: {base}')
      print(self.env.Y[-1, :].mean())
