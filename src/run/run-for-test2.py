...
from src.run.test import Simulator_test, Simulator_test1
import torch
import faulthandler
...
if __name__ == '__main__':
  ...
  args = get_args(env_name = 'sis', policy_name = 'one_step', argmaxer_name = 'quad_approx', seed = 20, rollout_depth = 1, number_of_replicates = 1,
  ...
  faulthandler.enable()
  Sim = Simulator_test1(args.rollout_depth, args.env_name, args.time_horizon, args.number_of_replicates, args.policy_name,
