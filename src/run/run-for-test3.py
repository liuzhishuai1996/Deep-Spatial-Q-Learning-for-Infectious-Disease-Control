...
from src.run.test import Simulator_test, Simulator_test1, Simulator_test2
import torch
import faulthandler
...
if __name__ == '__main__':
  ...
  args = get_args(env_name = 'sis', policy_name = 'one_step', argmaxer_name = 'quad_approx', seed = 5, rollout_depth = 1, number_of_replicates = 1,
                  omega = 0, time_horizon = 25, evaluation_budget = 100, L = 100, gamma = 0.9, epsilon = 0, network = 'lattice',
                  learn_embedding = 'True', raw_features = 'False', error_quantile = 0.95, ignore_errors = 'True', save_features = 'False',
  ...
  faulthandler.enable()
  Sim = Simulator_test2(args.rollout_depth, args.env_name, args.time_horizon, args.number_of_replicates, args.policy_name,
